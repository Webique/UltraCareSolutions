export const siteConfig = {
  links: {
    x: "https://x.com/landingTemplate",
    instagram: "https://www.instagram.com/landingTemplate",
    facebook: "https://facebook.com/landingTemplate",
    tiktok: "https://www.tiktok.com/@landingTemplate",
